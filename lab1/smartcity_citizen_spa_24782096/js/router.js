        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-5 col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 p-4">
                    ...
                    <!-- Divider & tombol daftar -->
                    <div class="mt-3 pt-3" style="border-top:1px solid #e5e7eb;">
                        <p class="text-center text-muted small mb-2">Belum punya akun?</p>
            ...
            <div class="col-md-5 col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 p-4">
                    <div class="text-center mb-4">
                        ...
                        <h5 class="fw-bold mb-0">Daftar Akun</h5>
                        <p class="text-muted small mt-1">Smart City Portal · PIE 1416</p>
                    </div>
                    ...
                    <!-- Kembali ke login -->
                    <div class="mt-3 pt-3" style="border-top:1px solid #e5e7eb;">
                        <p class="text-center text-muted small mb-2">Sudah punya akun?</p>
            ...
            <aside class="col-12 col-lg-3">
                <div class="card border-0 shadow-sm rounded-4 p-3 sticky-top" style="top:80px;">
                    ...
                    <div class="d-flex flex-column gap-2 mb-3" id="summaryStats">
                        ...
                        <div class="d-flex justify-content-between align-items-center p-2 rounded-3 bg-light">
                            <span class="small"><i class="bi bi-arrow-repeat me-1 text-primary"></i>Diproses</span>
                            <span class="badge bg-primary" id="statDiproses">0</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center p-2 rounded-3 bg-light">
                            <span class="small"><i class="bi bi-check-circle me-1 text-success"></i>Selesai</span>
                            <span class="badge bg-success" id="statSelesai">0</span>
                        </div>
                    </div>

                    <hr class="my-1">
                    <button class="btn btn-light btn-sm text-start rounded-3 border text-danger w-100" onclick="logout()">
...
function handleRouting() {
    ...
    if (hash === '#register' && typeof setupRegisterForm === 'function') setupRegisterForm();
    if (hash === '#dashboard' && typeof loadDashboardData === 'function') loadDashboardData('my_reports', 1);
}
